...
const situationalQuestions = [
  ...
  { category: 'Vie quotidienne', situation: true, question: 'Votre enfant est malade et ne peut pas aller à l’école. Que faites-vous ?', answer: 'Prévenir l’école le jour même et justifier son absence', choices: ['Prévenir l’école le jour même et justifier son absence', 'Ne rien signaler si l’absence dure moins d’une semaine', 'Demander à un voisin de prévenir la mairie', 'Attendre le retour des vacances scolaires'] },
  { category: 'Vie quotidienne', situation: true, question: 'Un voisin fait beaucoup de bruit à 2 heures du matin. Quelle est la meilleure réaction ?', answer: 'Lui parler calmement, puis appeler la police si le trouble persiste', choices: ['Lui parler calmement, puis appeler la police si le trouble persiste', 'Couper son électricité soi-même', 'Répondre en faisant davantage de bruit', 'Publier son adresse sur les réseaux sociaux'] },
  { category: 'Vie quotidienne', situation: true, question: 'Où déposer un ancien réfrigérateur ?', answer: 'À la déchetterie ou lors d’une collecte d’encombrants', choices: ['À la déchetterie ou lors d’une collecte d’encombrants', 'Sur le trottoir sans autorisation', 'Dans une poubelle classique', 'Dans le hall de l’immeuble'] },
  { category: 'Droits & devoirs', situation: true, question: 'Vous êtes témoin d’un grave accident de voiture. Que faites-vous en premier ?', answer: 'Sécuriser les lieux puis appeler les secours', choices: ['Sécuriser les lieux puis appeler les secours', 'Déplacer immédiatement toutes les victimes', 'Filmer la scène et la publier', 'Quitter les lieux sans prévenir personne'] },
  { category: 'Droits & devoirs', situation: true, question: 'Vous entendez des appels à l’aide chez un voisin. Quelle attitude adopter ?', answer: 'Appeler immédiatement la police au 17', choices: ['Appeler immédiatement la police au 17', 'Attendre plusieurs jours pour vérifier', 'Entrer par effraction', 'Mettre la musique plus fort'] },
  { category: 'Droits & devoirs', situation: true, question: 'Vous suspectez une fuite de gaz dans votre immeuble. Que devez-vous faire ?', answer: 'Ne pas allumer de lumière, sortir et appeler les secours', choices: ['Ne pas allumer de lumière, sortir et appeler les secours', 'Allumer une bougie pour chercher la fuite', 'Actionner tous les interrupteurs', 'Rester dans l’appartement et attendre'] },
  { category: 'Principes & valeurs', situation: true, question: 'Vous êtes agent d’une mairie. Pouvez-vous porter un signe religieux visible au travail ?', answer: 'Non, les agents publics sont soumis à la neutralité religieuse', choices: ['Non, les agents publics sont soumis à la neutralité religieuse', 'Oui, car aucune règle ne s’applique aux agents', 'Oui, uniquement le vendredi', 'Seulement si les usagers sont d’accord'] },
  { category: 'Principes & valeurs', situation: true, question: 'Vous êtes usager d’une préfecture et portez un signe religieux. Est-ce autorisé ?', answer: 'Oui, tant que vous respectez la loi et l’ordre public', choices: ['Oui, tant que vous respectez la loi et l’ordre public', 'Non, tout signe religieux est interdit aux usagers', 'Seulement avec une autorisation du préfet', 'Uniquement dans les bureaux privés'] },
  { category: 'Institutions', situation: true, question: 'La police vous demande vos papiers lors d’un contrôle d’identité. Que faites-vous ?', answer: 'Rester calme et présenter un document d’identité', choices: ['Rester calme et présenter un document d’identité', 'Refuser systématiquement de répondre', 'Détruire ses papiers', 'Appeler son employeur pour décider'] },
  { category: 'Institutions', situation: true, question: 'Vous trouvez un portefeuille dans la rue. Que faites-vous ?', answer: 'Le déposer au commissariat ou au service des objets trouvés', choices: ['Le déposer au commissariat ou au service des objets trouvés', 'Garder l’argent et jeter les papiers', 'Le laisser sur la chaussée', 'Le vendre sur internet'] },
  { category: 'Droits & devoirs', situation: true, question: 'Un restaurant refuse une personne en fauteuil roulant parce que cela gênerait le service. Que dit la loi ?', answer: 'C’est une discrimination interdite', choices: ['C’est une discrimination interdite', 'C’est toujours au client de trouver une solution', 'C’est autorisé si le restaurant est occupé', 'C’est uniquement un problème commercial'] },
  { category: 'Droits & devoirs', situation: true, question: 'Un employeur licencie un salarié parce qu’il a fait grève. Est-ce légal ?', answer: 'Non, le licenciement pour avoir exercé le droit de grève est illégal', choices: ['Non, le licenciement pour avoir exercé le droit de grève est illégal', 'Oui, la grève est interdite en France', 'Oui, si la grève dure plus d’une heure', 'Seulement si le salarié est majeur'] },
  { category: 'Vie quotidienne', situation: true, question: 'La cantine ne propose pas le plat correspondant à votre religion. Que pouvez-vous demander ?', answer: 'Un menu sans viande ou végétarien s’il existe', choices: ['Un menu sans viande ou végétarien s’il existe', 'Un menu confessionnel obligatoire', 'La fermeture de la cantine', 'Une dispense permanente de scolarité'] },
  { category: 'Vie quotidienne', situation: true, question: 'Vous n’êtes pas d’accord avec une punition donnée par l’enseignant. Que faites-vous ?', answer: 'Demander un rendez-vous avec l’enseignant ou le directeur', choices: ['Demander un rendez-vous avec l’enseignant ou le directeur', 'Menacer l’enseignant', 'Refuser toute future scolarisation', 'Saisir directement le Parlement'] },
  { category: 'Vie quotidienne', situation: true, question: 'Vous souhaitez inscrire votre enfant de 3 ans à l’école. Que prévoit la loi ?', answer: 'L’instruction est obligatoire dès 3 ans', choices: ['L’instruction est obligatoire dès 3 ans', 'L’école ne commence qu’à 6 ans', 'L’inscription dépend du lieu de travail des parents', 'L’enfant doit attendre le collège'] },
  { category: 'Vie quotidienne', situation: true, question: 'Vous organisez une fête chez vous. Quelle précaution prendre ?', answer: 'Prévenir les voisins et réduire le bruit le soir', choices: ['Prévenir les voisins et réduire le bruit le soir', 'Ne prévenir personne et augmenter la musique', 'Bloquer l’accès à l’immeuble', 'Obliger les voisins à participer'] },
  { category: 'Vie quotidienne', situation: true, question: 'Un conflit vous oppose à votre voisin sur la limite du jardin. Que faire ?', answer: 'Chercher un accord amiable ou un médiateur', choices: ['Chercher un accord amiable ou un médiateur', 'Modifier la clôture pendant la nuit', 'Menacer le voisin', 'Appeler les secours pour trancher'] },
  { category: 'Vie quotidienne', situation: true, question: 'Le pharmacien propose un médicament générique. Quelle réponse est adaptée ?', answer: 'L’accepter : il contient la même molécule active', choices: ['L’accepter : il contient la même molécule active', 'Le refuser car il est toujours inefficace', 'Le donner à un voisin', 'Le prendre sans lire la prescription'] },
  { category: 'Vie quotidienne', situation: true, question: 'Vous devez vous arrêter de travailler pour vous occuper d’un enfant. Qui peut demander un congé parental ?', answer: 'La mère ou le père', choices: ['La mère ou le père', 'Uniquement le grand-parent', 'Uniquement l’employeur', 'Personne dans cette situation'] },
  { category: 'Vie quotidienne', situation: true, question: 'Vous déménagez dans une autre ville. Quelle démarche est importante ?', answer: 'Mettre à jour votre adresse auprès des organismes concernés', choices: ['Mettre à jour votre adresse auprès des organismes concernés', 'Ne prévenir personne pendant dix ans', 'Changer uniquement votre numéro de téléphone', 'Prévenir seulement vos voisins'] },
  { category: 'Droits & devoirs', situation: true, question: 'Un ami veut conduire après avoir beaucoup bu. Que faites-vous ?', answer: 'L’empêcher de conduire et proposer une autre solution', choices: ['L’empêcher de conduire et proposer une autre solution', 'L’encourager à rouler lentement', 'Lui prêter votre voiture', 'Ignorer la situation'] },
  { category: 'Droits & devoirs', situation: true, question: 'Vous voyez une personne âgée debout dans les transports. Quelle attitude est civique ?', answer: 'Lui céder votre place', choices: ['Lui céder votre place', 'Lui demander de descendre', 'Faire semblant de dormir', 'Réserver plusieurs places'] },
  { category: 'Droits & devoirs', situation: true, question: 'Vous jetez un emballage par la fenêtre de votre voiture. Que risquez-vous ?', answer: 'Une amende pour abandon de déchets', choices: ['Une amende pour abandon de déchets', 'Aucune conséquence', 'Une récompense citoyenne', 'Un permis de conduire automatique'] },
  { category: 'Droits & devoirs', situation: true, question: 'Vous ne comprenez pas les consignes de tri. Que devez-vous faire ?', answer: 'Trier les déchets dans les poubelles adaptées', choices: ['Trier les déchets dans les poubelles adaptées', 'Tout mettre dans la poubelle classique', 'Déposer les déchets dans la rue', 'Les brûler dans le jardin'] },
  { category: 'Principes & valeurs', situation: true, question: 'Une personne se moque publiquement d’une religion. Dans quel cas cela peut-il être puni ?', answer: 'Si elle appelle à la haine ou à la violence contre des croyants', choices: ['Si elle appelle à la haine ou à la violence contre des croyants', 'Dès qu’une opinion déplaît', 'Dès qu’elle parle de religion', 'Jamais, même en cas de menace'] },
  { category: 'Principes & valeurs', situation: true, question: 'Un proche menace une personne qui change de religion. Que faut-il retenir ?', answer: 'Changer de religion est libre et les menaces sont punissables', choices: ['Changer de religion est libre et les menaces sont punissables', 'La famille décide de la religion', 'Changer de religion est interdit', 'Les menaces sont autorisées en privé'] },
  { category: 'Principes & valeurs', situation: true, question: 'Lors d’une manifestation autorisée, la police demande de se disperser. Que faites-vous ?', answer: 'Obéir à la demande de dispersion', choices: ['Obéir à la demande de dispersion', 'Rester par provocation', 'Empêcher les policiers de travailler', 'Jeter des objets'] },
  { category: 'Principes & valeurs', situation: true, question: 'Un agent immobilier refuse une visite à cause de votre couleur de peau. Quel recours est possible ?', answer: 'Saisir le Défenseur des droits et porter plainte', choices: ['Saisir le Défenseur des droits et porter plainte', 'Accepter car c’est son choix', 'Menacer l’agent', 'Changer de nationalité'] },
  { category: 'Principes & valeurs', situation: true, question: 'Vous êtes témoin d’une agression verbale homophobe. Que faites-vous ?', answer: 'Alerter la police et témoigner si nécessaire', choices: ['Alerter la police et témoigner si nécessaire', 'Rire avec l’agresseur', 'Filmer sans jamais alerter', 'Demander à la victime de partir'] },
  { category: 'Principes & valeurs', situation: true, question: 'Une femme mariée veut ouvrir un compte bancaire seule. Est-ce possible ?', answer: 'Oui, elle peut ouvrir un compte sans l’autorisation de son époux', choices: ['Oui, elle peut ouvrir un compte sans l’autorisation de son époux', 'Non, son époux doit signer', 'Uniquement avec l’accord de la mairie', 'Uniquement après un divorce'] },
  { category: 'Principes & valeurs', situation: true, question: 'Une entreprise paie une femme moins qu’un homme à compétences égales. Que dit la loi ?', answer: 'À travail de valeur égale, le salaire doit être égal', choices: ['À travail de valeur égale, le salaire doit être égal', 'L’employeur peut toujours le faire', 'La différence est obligatoire', 'Cela ne concerne que les fonctionnaires'] },
  { category: 'Institutions', situation: true, question: 'Vous recevez une amende, mais vous n’étiez pas le conducteur. Que faites-vous ?', answer: 'Contester en désignant la personne qui conduisait', choices: ['Contester en désignant la personne qui conduisait', 'Ignorer l’amende', 'La jeter immédiatement', 'Payer deux fois'] },
  { category: 'Institutions', situation: true, question: 'Vous manquez de ressources pour payer un avocat. Quelle aide demander ?', answer: 'L’aide juridictionnelle', choices: ['L’aide juridictionnelle', 'Une autorisation de la police', 'Une carte de transport', 'Un permis de construire'] },
  { category: 'Institutions', situation: true, question: 'Vous devez remplir une déclaration de revenus mais vous n’avez aucun revenu. Que faire ?', answer: 'Déclarer tout de même ses revenus, même s’ils sont nuls', choices: ['Déclarer tout de même ses revenus, même s’ils sont nuls', 'Ne jamais faire de déclaration', 'Déclarer uniquement à la mairie', 'Attendre d’avoir un emploi'] },
  { category: 'Institutions', situation: true, question: 'Votre employeur vous demande pour qui vous avez voté. Devez-vous répondre ?', answer: 'Non, le vote est personnel et secret', choices: ['Non, le vote est personnel et secret', 'Oui, c’est obligatoire', 'Oui, si l’employeur insiste', 'Seulement par écrit'] },
  { category: 'Institutions', situation: true, question: 'Avec une carte de résident, pouvez-vous voter à l’élection présidentielle ?', answer: 'Non, ce vote est réservé aux citoyens français', choices: ['Non, ce vote est réservé aux citoyens français', 'Oui, automatiquement', 'Oui, après cinq ans de résidence', 'Seulement si le maire l’autorise'] },
  { category: 'Institutions', situation: true, question: 'Comment participer à la vie locale sans avoir la nationalité française ?', answer: 'S’investir dans une association ou un conseil de quartier', choices: ['S’investir dans une association ou un conseil de quartier', 'Voter à toutes les élections nationales', 'Devenir automatiquement maire', 'Remplacer les élus'] },
  { category: 'Institutions', situation: true, question: 'Vous avez oublié votre déclaration d’impôts. Quelle démarche entreprendre ?', answer: 'La faire rapidement, en sachant qu’une pénalité est possible', choices: ['La faire rapidement, en sachant qu’une pénalité est possible', 'Ne jamais la faire', 'Attendre une convocation judiciaire', 'Changer de domicile sans prévenir'] },
  { category: 'Vie quotidienne', situation: true, question: 'Vous êtes malade et ne pouvez pas aller travailler. Que devez-vous faire ?', answer: 'Prévenir l’employeur et envoyer un arrêt de travail médical', choices: ['Prévenir l’employeur et envoyer un arrêt de travail médical', 'Ne rien dire', 'Demander à un collègue de signer à votre place', 'Venir travailler malgré tout'] },
  { category: 'Vie quotidienne', situation: true, question: 'Lors d’un entretien, on vous demande votre orientation sexuelle. Que pouvez-vous faire ?', answer: 'Ne pas répondre, car cela relève de la vie privée', choices: ['Ne pas répondre, car cela relève de la vie privée', 'Inventer une réponse obligatoire', 'Fournir un document médical', 'Demander à votre famille de répondre'] },
  { category: 'Vie quotidienne', situation: true, question: 'Un employeur propose du travail non déclaré le week-end. Que faites-vous ?', answer: 'Refuser, car le travail dissimulé est illégal', choices: ['Refuser, car le travail dissimulé est illégal', 'Accepter si le salaire est élevé', 'Accepter sans prévenir personne', 'Demander à un enfant de le faire'] },
  { category: 'Vie quotidienne', situation: true, question: 'Vous refusez de recevoir les consignes d’une collègue parce que c’est une femme. Que dit la règle ?', answer: 'Le refus fondé sur le sexe est interdit', choices: ['Le refus fondé sur le sexe est interdit', 'C’est un droit professionnel', 'Cela dépend de l’âge', 'C’est obligatoire dans certaines entreprises'] },
  { category: 'Vie quotidienne', situation: true, question: 'Vous voulez abattre un grand arbre dans votre jardin. Quelle précaution prendre ?', answer: 'Se renseigner auprès de la mairie sur les autorisations nécessaires', choices: ['Se renseigner auprès de la mairie sur les autorisations nécessaires', 'L’abattre sans vérifier', 'Le brûler sur place', 'Demander l’autorisation d’un voisin seulement'] },
  { category: 'Droits & devoirs', situation: true, question: 'Des parents veulent marier leur fille majeure contre sa volonté. Que dit la loi ?', answer: 'Le mariage exige le consentement libre des deux époux', choices: ['Le mariage exige le consentement libre des deux époux', 'Les parents peuvent toujours décider', 'Le mariage forcé est autorisé en famille', 'Le consentement n’est pas nécessaire après 18 ans'] },
  { category: 'Droits & devoirs', situation: true, question: 'Après un divorce, qui conserve en général l’autorité parentale ?', answer: 'Les deux parents conjointement', choices: ['Les deux parents conjointement', 'Uniquement le parent qui a le logement principal', 'Le maire', 'L’école'] },
  { category: 'Droits & devoirs', situation: true, question: 'Un parent frappe son enfant pour le punir. Est-ce autorisé ?', answer: 'Non, les violences éducatives sont interdites', choices: ['Non, les violences éducatives sont interdites', 'Oui, si le coup est léger', 'Oui, jusqu’à la majorité', 'Seulement avec l’accord de l’école'] },
  { category: 'Droits & devoirs', situation: true, question: 'Une jeune fille de 16 ans demande une contraception. Que peut-elle faire ?', answer: 'Y accéder gratuitement et anonymement auprès d’un professionnel', choices: ['Y accéder gratuitement et anonymement auprès d’un professionnel', 'Obtenir une autorisation obligatoire de tous ses proches', 'Attendre sa majorité', 'Demander l’accord de son employeur'] },
  { category: 'Principes & valeurs', situation: true, question: 'À compétences égales, une femme est moins payée qu’un homme. Quel recours est possible ?', answer: 'Saisir le conseil de prud’hommes', choices: ['Saisir le conseil de prud’hommes', 'Accepter car c’est légal', 'Demander à la mairie de fixer le salaire', 'Démissionner sans aucun recours'] },
  { category: 'Institutions', situation: true, question: 'Vous trouvez un portefeuille avec des papiers et de l’argent. Que devez-vous faire ?', answer: 'Le remettre à la police ou au service des objets trouvés', choices: ['Le remettre à la police ou au service des objets trouvés', 'Garder l’argent et jeter les papiers', 'Le déposer dans une boîte aux lettres', 'Le vendre sur un site internet'] },
...
const sourcesByCategory = {
  'Principes & valeurs': { label: 'Éducation nationale · Laïcité et valeurs de la République', url: 'https://www.education.gouv.fr/la-laicite-l-ecole-12482' },
  Institutions: { label: 'Vie-publique · Les institutions de la République', url: 'https://www.vie-publique.fr/fiches/23911-les-institutions-de-la-republique' },
  'Droits & devoirs': { label: 'Service-Public · Citoyenneté et démarches', url: 'https://www.service-public.fr/particuliers/vosdroits/N47' },
